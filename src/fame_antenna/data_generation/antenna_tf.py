...
class Antenna():
    ...
    def all_f_3_1(self, i, j, k):
        return tf.convert_to_tensor([self.f_3_1(i, j, k), self.f_3_1(j, k, i), self.f_3_1(k, i, j)])
    ...
    def all_f_3_0(self, i, j, k):
        return tf.convert_to_tensor([self.f_3_0(i, j, k), self.f_3_0(j, k, i), self.f_3_0(k, i, j)])
    ...
    def all_d_3_1(self, i, j, k):
        return tf.convert_to_tensor([self.d_3_1(i, j, k), self.d_3_1(i, k, j)])
    ...
    def all_a_3_1(self, i, j, k):
        return tf.convert_to_tensor([self.a_3_1(i, j, k), self.a_3_1(k, j, i)])
    ...
    def ar(self, i, j, k):
        ...
        c = frac(tf.math.log(self.y_ij), self.s_ijk)*(2-frac(self.s_ij*self.s_jk, 2*(self.s_ik+self.s_jk)**2)+2*frac(self.s_ij-self.s_jk, self.s_ik+self.s_jk))
    ...
    # def zlog(self, z):
    #     if z >= 0.0:
    #         zlog = tf.complex(tf.math.log(z), 0.0)*tf.complex(1.0, 0.0)
    #     else:
    #         zlog = tf.complex(tf.math.log(abs(z)), 0.0)-tf.complex(0.0, math.pi)
    #     return zlog
    ...
    def set_indices(self, i, j, k):
        ...
        self.T = 11/6*(tf.math.log(self.mu**2/self.s_ijk))
